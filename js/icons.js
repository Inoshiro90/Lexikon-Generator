 ...
 * icons.js
 * ──────────────────────────────────────────────────────────────────
 * Inline SVG icon set (Lucide subset).
 * Stroke-based, 2px, round caps/joins — Warm Design System spec.
 * No CDN required.
 * ──────────────────────────────────────────────────────────────────
 */
...
/* ================================================================
   SVG DEFINITIONS
   All icons at 15×15 viewBox (scaled via width/height attrs).
   ================================================================ */
...
const _SVG = {
  ...
  'x-circle':     `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="15" y1="9" x2="9" y2="15"/><line x1="9" y1="9" x2="15" y2="15"/></svg>`,
  'settings-2':   `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 7h-9"/><path d="M14 17H5"/><circle cx="17" cy="17" r="3"/><circle cx="7" cy="7" r="3"/></svg>`,
...
/**
 * Return an SVG string for a named icon, scaled to `size`.
 * @param {string} name  — icon key from _SVG
